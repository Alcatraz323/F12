...
public class TwoDScrollView extends FrameLayout {
	...
	private OnRequireScrollListener ors;
	...
	public void setOnRequireScrollListener(OnRequireScrollListener ors){
		this.ors=ors;
	}
    @Override
   ...
   */
	...
	interface OnRequireScrollListener{
		public void onScroll(int px,int pz);
	}
    @Override
